...
export default function Hero() {
  return (
    <section id="hero" className="relative pt-12 min-h-[80vh] sm:min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50">
      ...
      <div className="absolute top-40 left-10 w-72 h-72 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-32 text-center">
        <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
          ...
          {/* Badge */}
          <div className="inline-block px-3 py-2.5 sm:px-4 sm:py-2 bg-white/60 backdrop-blur-sm rounded-full text-xs sm:text-sm font-medium text-purple-600 border border-purple-200">
          ...
          <div className='flex justify-center'>
            <img 
              ...
              className="h-20 sm:h-32 lg:h-40"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-6 sm:pt-8">
           ...
           >
            ...
            <a
            href='\Summerise_pamphlet_TGI.pdf'
            target='_blank'
            rel='noopener noreferrer'
